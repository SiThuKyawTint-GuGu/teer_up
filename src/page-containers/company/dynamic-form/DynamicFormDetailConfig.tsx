"use client";
import { useGetFormConfigById, usePostFormConfig, useUpdateFormConfig } from "@/services/dynamicFormConfigCompany";
import {
  useDeleteInputConfig,
  useGetInputConfig,
  usePostInputConfig,
  useUpdateInputConfig,
} from "@/services/dynamicInputConfigCompany";
...
const FormDetailConfigPage = ({ id }: Props) => {
  ...
  const handleAddFormConfig = async (data: any) => {
    ...
    router.push("/company/dynamic-form");
  };
